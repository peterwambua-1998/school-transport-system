...
class BusLate extends Notification
{
    use Queueable;
    ...
    {
        return [
            'body' => "Vehicle $this->vehicle_title $this->vehicle_reg will arrive late, Driver Name: $this->driver_name, Contact: $this->driver_phone."
        ];
    }
}
