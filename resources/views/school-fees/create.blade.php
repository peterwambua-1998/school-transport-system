    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" id="my-form" action="{{ route('school-fees.store') }}">
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    @if(count($grades) <= 0)
                                        <p class="text-danger">All {{ucfirst($tr->plural) ?? 'Grades'}} have school fees for this term.</p>
                                    @else
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input required type="text" id="year" class="form-control" name="year" readonly value="{{date('Y')}}">
                                </div>
                            </div><!-- Col -->
                        </div><!-- Row -->
                        ...
                        <div class="table-holder">
                            <table class="table table-responsive table-bordered" id="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control entries" name="entries[]" required>
                                            <span class="entry_error my-error"></span>
                                        </td>
                                        <td>
                                            <input type="number" name="amount[]" placeholder="0" class="form-control amounts" required>
    ...
    $('#add').click(function () {
        ...
        $('#table').append(
            `<tr>
                ...
                <td>
                    <input type="text" name="amount[]" placeholder="Quantity" class="form-control amounts" required>
                    <span class="my-error"></span>
                </td>
                <td>
