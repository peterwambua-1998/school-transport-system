...
@endif
<form action="{{route('allocation_save_dropoff')}}" method="post">
    @csrf
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Vehicle allocation - Drop-off point.</h6>
                <hr class="mb-4 mt-4">
                <!-- student parent zone -->
                ...
                <div id="route-color-codes-div">
                    ...
                    <div class="mb-5 " id="color-codes" style="display: flex; gap: 5%;"></div>
                </div>
                ...
                <div id="route-vehicle-trips-div" style="display: flex; gap: 10px; width: 100%" class="mb-3">
                    ...
                    <div class="mb-3" style="width: 100%" id="trips-append">
...
function initMap() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            positions = {lat: response.student.lat_drop - 0, lng: response.student.lng_drop - 0};
...
$('#routes').on('change', function() {
    ...
    console.log(route_id, student_id);
