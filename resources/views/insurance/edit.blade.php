...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit {{$vehicle->plate_num}} insurance</h4>
                <hr>
                <form action="{{ route('insurance.update', $insurance->id) }}"  method="POST" id="my-form">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <select name="type" class="form-select" id="type" required>
                                ...
                                <option @if ($insurance->type == 'Comprehensive')
                                    selected
                                @endif value="Comprehensive">Comprehensive</option>
                                <option @if ($insurance->type == 'Third party')
                                    selected
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="ins_num" class="form-control" id="ins_num" placeholder="54321" value="{{$insurance->ins_num}}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="text" placeholder="company" name="company" class="form-control" id="company" value="{{$insurance->ins_company}}" required>
                            <span class="issue" id="company_error"></span>
                        </div>

                        <div class="mb-3 col-md-6 col-sm-12">
                            <label class="form-label" for="issue_date">Issue Date</label>
                            <input type="date"  name="issue_date" class="form-control" id="issue_date" value="{{$insurance->issue_date}}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="date"  name="date_renewed" class="form-control" id="date_renewed" value="{{$insurance->renew_date}}" required>
                            <span class="issue" id="date_renewed_error"></span>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="validity">Validity (Days)</label>
                            <input type="number" name="validity" id="validity" class="form-control" value="{{$insurance->validity}}">
                            <span class="issue" id="validity_error"></span>
                        </div>
                    </div>

                    <div class="text-center">
                        <button type="button" id="my-submit" class="btn btn-success mt-3"><ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon> Update Insurance</button>
                    </div>
