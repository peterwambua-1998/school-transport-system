...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit {{$driver->name }} License</h4>
                <hr>
                <form action="{{ route('license.update', $driver->license->id) }}"  method="POST" id="my-form">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="hidden" name="driver_id" value="{{$driver->license->driver_id}}">
                        </div>

                        <div class="mb-3 col-md-6 col-sm-12">
                            <label class="form-label" for="dl_number">DL Number</label>
                            <input type="number" name="dl_number"  class="form-control" id="dl_number" placeholder="DL Number" required value="{{$driver->license->dl_number}}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="dl_class" class="form-control" id="dl_class" required value="{{$driver->license->dl_class}}">
                            <span class="issue" id="dl_class_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="date_issued">Date Issued</label>
                            <input type="date" name="date_issued" class="form-control" id="date_issued" required value="{{$driver->license->date_issued}}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" name="date_renewed" class="form-control" id="date_renewed" required value="{{$driver->license->date_renewed}}">
                            <span class="issue" id="date_renewed_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="validity">Validity (Years)</label>
                            <input type="number" name="validity" class="form-control" id="validity" required value="{{$driver->license->validity}}">
                            <span class="issue" id="validity_error"></span>
                        </div>
                    </div>

                    <div class="text-center">
                        <button type="button" id="submit-btn"  class="btn btn-success mt-3"><ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon> Update License</button>
                    </div>
