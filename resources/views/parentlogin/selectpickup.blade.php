...
<div class="top-navigation" style="background: #e2e8f0">
    <p><span >Select {{ $student->first_name }}</span> - <span style="font-weight:500;">Pickup/Drop off</span></p>
    <form action="{{ route('changepickupsave') }}" method="post">
        @csrf
        <input type="hidden" name="lat" id="lat" required>
        <input type="hidden" name="lng" id="lng" required>
        <input type="hidden" name="student_id" value="{{ $student->id }}">

        <button type="submit" class="btn btn-primary" id="submit" style="float: right;border-radius:5px" >Save Pickup/Drop off</button>
    </form>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <p>Click on map to select pickup/drop off points</p>
