...
<div class="top-navigation" style="background: #e2e8f0">
    <p><span >Changed</span> - <span style="font-weight:500;">Pickup/Drop off</span></p>
    <form action="{{ route('changepickupsave') }}" method="post">
        ...
        <button type="submit" class="btn btn-primary" id="submit" style="float: right;border-radius:5px" >Confirm</button>
    </form>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <p>Click on map to change pickup/drop off points</p>
