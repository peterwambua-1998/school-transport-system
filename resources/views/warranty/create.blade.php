...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add Vehicle warranty</h4>
                <hr>
                <form id="my-form" action="{{ route('warranty.store') }}"  method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" placeholder="0" name="waranty_value" id="waranty_value" class="form-control">
                            <span class="issue" id="waranty_value_error"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label" for="dealer">Dealer</label>
                            <input type="text" placeholder="Dealer" name="dealer" id="dealer" class="form-control">
                    ...
                    <div class="text-center">
                        <button id="submit-btn" type="button" class="btn btn-success mt-3"><ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon> Add Warranty</button>
                    </div>
