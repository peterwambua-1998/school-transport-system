...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Vehicle Inspection</h4>
                <hr>
                <form action="{{ route('inspection.update', $inspection->id) }}" id="inspection-form"  method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="mb-3 col-md-6 col-sm-12">
                            <label class="form-label" for="title">Bus Reg. No </label>
                            <input readonly type="text" class="form-control" name="vehicle" id="" value="{{$vehicle->plate_num}}" readonly>
                        ...
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="date"  name="last_inspection" class="form-control" id="last_inspection" value="{{$inspection->last_inspection}}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-sm-12">
                            ...
                            <input type="date" name="next_inspection" class="form-control" id="next_inspection" required value="{{$inspection->next_inspection}}">
                            <span class="issue" id="next_inspection_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="platenum">Location Name </label>
                            <input type="text" placeholder="Location Name" name="location_name" id="pac-input" class="form-control" value="{{$inspection->location_name}}">
                    ...
                    <input type="hidden" name="lat" id="lat" value="{{$inspection->lat}}">
                    <input type="hidden" name="lng" id="lng" value="{{$inspection->lng}}">

                    <div class="text-center">
                    <button type="button" id="submit-btn" class="btn btn-success mt-3"><ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon> Update Inspection</button>
                    </div>
    ...
    <script defer>
        function initMap() {
            ...
            new google.maps.Marker({
                ...
                label: {text: "Current Inspection location", color: "#1e293b", fontSize: "15px", className: "label-marker"},
                icon: {
                    url: image,
