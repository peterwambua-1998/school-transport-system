...
<div class="top-navigation">
    <p><span style="color: #0071f3">Unpaid Invoice</span> - <span style="font-weight:500;">List Viewer </span></p>
        ...
        <div class="page-w p-2 m-0" style="background: #fff">
            <form action="">
                ...
                <div class="form-group col-md-2 m-0">
                    ...
                    <button type="button" class="btn get-data-unpaid" style="background: #0071f3; width: 100%; color: #fff">Submit</button>
                </div>
                </div>
            </form>
        </div>
