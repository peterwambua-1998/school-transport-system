...
<div class="p-2" style="border-bottom: 2px solid #f3f4f6; display: grid; grid-template-columns:60% 1fr; gap: 2%; background:#f3f4f6">
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body" style="line-height: 30px;">
            ...
            <p class="text-success">3. You can remove a marker by clicking on it.</p>
        </div>
