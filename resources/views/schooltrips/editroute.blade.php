...
<div class="p-2" style="border-bottom: 2px solid #f3f4f6; display: flex; flex-direction:row-reverse; gap: 5px;background:#f3f4f6">
    ...
    <button class="btn btn-success" id="save-btn" style="width: 15%">
        <ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon>
        Save Path
    </button>
    <a href="{{ route('showroutepath', $schooltrip->id) }}" class="btn btn-warning" id="save-btn" style="width: 15%">
        <ion-icon style="position: relative; top:3px; right: 5px; color: #000; font-size: 16px" name="arrow-back-circle-outline"></ion-icon>
        Cancel
    </a>
