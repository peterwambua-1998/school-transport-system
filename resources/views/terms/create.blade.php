...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add School Term</h4>
                <hr>
                <form action="{{ route('term.store') }}"  method="POST" id="my-form">
                    @csrf
                    <div class="row">
                        ...
                        <input type="text" name="year" readonly value="{{ $year }}" class="form-control" id="year" placeholder="Name" required>
                    ...
                    <div class="text-center">
                        <button class="btn btn-success mt-3" type="button" id="submit-btn"><ion-icon style="position: relative; top:2px; right: 5px; color: #fff;" name="save"></ion-icon> Add School Term</button>
                    </div>
