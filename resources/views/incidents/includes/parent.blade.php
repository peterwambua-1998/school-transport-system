...
<div class="table-responsive">
    <h5 class="card-title">Incidents caused by parents</h5>
    <table class="table table-bordered table-striped" style="width: 100%"  id="dataTableExample4" data-ordering="false">
        <thead>
            <tr>
                <th>#</th>
                <th>Parent</th>
        ...
        <tbody>
            <?php $number = 1; ?>
            @foreach ($incidentPts as $incidentAt)
