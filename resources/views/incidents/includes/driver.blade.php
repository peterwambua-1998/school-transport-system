...
<div class="table-responsive" style="width: 100%">
    <h5 class="card-title">Incidents caused by drivers</h5>
    <table class="table table-bordered table-striped" style="width: 100%" id="dataTableExample3" data-ordering="false">
        <thead>
            <tr>
                <th>#</th>
                <th>Driver</th>
        ...
        <tbody>
            <?php $number = 1; ?>
            @foreach ($incidentDrs as $incidentAt)
